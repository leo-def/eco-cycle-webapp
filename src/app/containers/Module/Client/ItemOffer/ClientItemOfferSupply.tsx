...
/**
 * ClientItemOfferSupply
 *   ClientItemOfferSupply component
 * @param {any}  props Properties
 * @return {React.Component} ClientItemOfferSupply Component
 */
export const ClientItemOfferSupply = (props: any) => {
...
export default ClientItemOfferSupply;
