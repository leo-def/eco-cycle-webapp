...
import { getTitle } from '../../../../../types/Entity/Measure/PhysicalQuantity/PhysicalQuantity';

export const PhysicalQuantityAutocomplete = (props: any) => {
  ...
  const { fetchResponse } = useSelector((state: RootState) => state.module.admin.physicalQuantity.fetch);
  ...
  const fetch = (fetchParams) => {
    dispatch({
      type: physicalQuantityFetchState.FETCH,
      payload: { fetchParams }
    })
  }
