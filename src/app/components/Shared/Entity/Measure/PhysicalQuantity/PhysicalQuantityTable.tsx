 ...
 *   PhysicalQuantityTable component
 * @param {any}  props Properties
 * @return {React.Component} PhysicalQuantityTable Component
 */
export const PhysicalQuantityTable = (props: any) => {
  const {
    rows,
    show,
    create,
...
export default PhysicalQuantityTable;